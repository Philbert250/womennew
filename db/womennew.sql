...
(6, 'phil', 'ndi', 'philbert@gmail.com', '+250785300822', 'Kigoma', 'adversor', 'dghg', 'hsgh', '1', 'mnb', 0);
...
--
-- Table structure for table `childborn`
--

CREATE TABLE `childborn` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `childborn`
--

INSERT INTO `childborn` (`id`, `parentid`, `firstname`, `lastname`, `gender`, `dob`, `status`) VALUES
(2, 11, 'dsj,', 'jdsmn', 'Male', '2023-01-01', 'Child Died');
...
(11, 'noea', 'Male', '2022-12-21', 'noahmuki@gmail.com', '+250783246226', 'Kinazi', '2022-12-04 16:42:50', 'mukur', 'mutunda', 1),
(12, 'mucyo', 'Male', '2022-01-01', 'niyofloie@gmail.com', '+250786461106', 'Karama', '2022-12-04 16:52:28', 'mukany', 'mudd', 1),
(13, 'mucyo', 'Male', '2022-01-01', 'niyofloie@gmail.com', '+250786461106', 'Karama', '2022-12-04 17:04:53', 'mukany', 'mudd', 1),
(14, 'rene', 'Male', '2022-01-01', 'floka', '+250786461106', 'Gishamvu', '2022-12-04 17:06:40', 'kayumba', 'niyo', 1),
(15, 'solange', 'Female', '2022-01-01', 'solange', '+250789283451', 'Karama', '2022-12-04 17:12:42', 'mnb', 'mnb', 1);
...
(6, '12', 'widiu', 'd', 'jkcd', 'jkdc', '2022-12-04 23:13:04', 0);
...
--
-- Indexes for table `childborn`
--
ALTER TABLE `childborn`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `childborn`
--
ALTER TABLE `childborn`
